        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HRContactName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HRContactEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HRContactLinkedIn = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalaryOffer = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobApplicationSkills", x => new { x.JobApplicationsId, x.SkillsId });
                    table.ForeignKey(
