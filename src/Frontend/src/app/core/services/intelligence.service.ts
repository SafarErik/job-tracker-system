  ...
  private readonly _mockSignals: GlobalSignal[] = [
    {
      ...
      summary:
        'A massive shift in hardware requirements is expected as NVIDIA rolls out Blackwell-based instances specifically tuned for high-frequency trading and financial modeling.',
      impactScore: 85,
      source: 'TechCrunch',
    ...
    },
    {
      ...
      summary:
        'Leaked internal memos suggest a transition to 4-day in-office minimums by Q3 2026. This move is triggering a talent migration towards tier-2 specialized AI startups.',
      impactScore: 92,
      source: 'The Verge',
    ...
    },
    {
      ...
      summary:
        'New compliance requirements in the EU have forced the Fortune 500 to expand their security teams. Senior Security Architect roles have seen a 25% salary increase.',
      impactScore: 78,
      source: 'Reuters',
    ...
    },
    {
      ...
      summary:
        'The new model series is designed to handle multi-step reasoning tasks previously reserved for human project managers. Integration with Jira and Slack is native.',
      impactScore: 95,
      source: 'Wired',
